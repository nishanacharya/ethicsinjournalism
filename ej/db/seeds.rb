...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    ...
    Post.create(headline: "Ken Assignment 1", draft1: "Draft 1-1", draft2: "Draft2-1", bookmarked: false, submitted: true, user_id: "3", assignment_id: "1")
    ...
    Position.create(title: "Against", post_id: "6", assignment_id: "4")
    Position.create(title: "For", post_id: "7", assignment_id: "5")
    Position.create(title: "Against", post_id: "8", assignment_id: "5")
    Position.create(title: "Against", post_id: "9", assignment_id: "5")
