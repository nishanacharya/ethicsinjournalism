...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    ...
    Post.create(headline: "Post 4", draft1: "Draft 1-4", draft2: "Draft2-4", bookmarked: false, user_id: "3", assignment_id: "3")   
    Post.create(headline: "Post 5", draft1: "Draft 1-5", draft2: "Draft2-5", bookmarked: false, user_id: "3", assignment_id: "3")   
    Post.create(headline: "Post 6", draft1: "Draft 1-6", draft2: "Draft2-6", bookmarked: false, user_id: "3", assignment_id: "5")   
    Post.create(headline: "Post 7", draft1: "Draft 1-7", draft2: "Draft2-7", bookmarked: false, user_id: "3", assignment_id: "5")   
    ...
    Position.create(title: "For", post_id: "7", assignment_id: "5")