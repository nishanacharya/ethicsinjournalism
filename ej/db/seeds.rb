...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    ...
    Post.create(headline: "Ken Assignment 1", draft1: "Draft 1-1", draft2: "Draft2-1", bookmarked: false, user_id: "3", assignment_id: "1")
    Post.create(headline: "Ken Assignment 2", draft1: "Draft 1-2", draft2: "Draft2-2", bookmarked: false, user_id: "3", assignment_id: "2")
    Post.create(headline: "Ken Assignment 3", draft1: "Draft 1-3", draft2: "Draft2-3", bookmarked: false, user_id: "3", assignment_id: "3")
    Post.create(headline: "Kathy Assignment 3", draft1: "Draft 1-4", draft2: "Draft2-4", bookmarked: false, user_id: "4", assignment_id: "3")   
    Post.create(headline: "Kathy Assignment 4", draft1: "Draft 1-5", draft2: "Draft2-5", bookmarked: false, user_id: "4", assignment_id: "4")   
    Post.create(headline: "Ken Assignment 5", draft1: "Draft 1-6", draft2: "Draft2-6", bookmarked: false, user_id: "3", assignment_id: "5")   
    Post.create(headline: "Kathy Assignment 5", draft1: "Draft 1-7", draft2: "Draft2-7", bookmarked: false, user_id: "4", assignment_id: "5")
    Post.create(headline: "Rick Assignment ", draft1: "Draft 1-8", draft2: "Draft2-8", bookmarked: false, user_id: "5", assignment_id: "5")
